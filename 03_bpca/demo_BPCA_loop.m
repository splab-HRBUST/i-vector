...
%% ------------------------------------------------TIMIT database 
% % GMM supervectors
% M_dev_all = importdata('E:/data_prep/timit/ubm_512/M_dev.mat');
% M_enroll = importdata('E:/data_prep/timit/ubm_512/M_enroll.mat');
% M_test   = importdata('E:/data_prep/timit/ubm_512/M_test.mat');
% 
% num.spk_dev = 530;
% num.spk_eva = 100;
% 
...
clear a b A
scores_BPCA_CDS_true = [scores_BPCA_CDS.true];
scores_BPCA_CDS_impostor = [scores_BPCA_CDS.impostor];
scores_BPCA_CDS = [scores_BPCA_CDS.true;scores_BPCA_CDS.impostor];
[eer_BPCA400_CDS,~,dcf_timit_BPCA400_CDS]=compute_eer(scores_BPCA_CDS,answer_eva,false);
...
clear a b A
scores_LDA_CDS_true = [scores_LDA_CDS.true];
scores_LDA_CDS_impostor = [scores_LDA_CDS.impostor];
scores_LDA_CDS = [scores_LDA_CDS.true;scores_LDA_CDS.impostor];
[eer_baseline_BPCA400_LDA200_CDS,~,dcf_timit_baseline_BPCA400_LDA200_CDS]=compute_eer(scores_LDA_CDS,answer_eva,false);
...
clear a b A
scores_BPCA_PLDA_true = [scores_BPCA_PLDA.true];
scores_BPCA_PLDA_impostor = [scores_BPCA_PLDA.impostor];
scores_BPCA_PLDA = [scores_BPCA_PLDA.true;scores_BPCA_PLDA.impostor];
[eer_BPCA400_PLDA200,~,dcf_timit_BPCA400_PLDA200]=compute_eer(scores_BPCA_PLDA,answer_eva,false);
...
clear a b A
scores_LDA_PLDA_true = [scores_LDA_PLDA.true];
scores_LDA_PLDA.impostor = [scores_LDA_PLDA.impostor];
scores_LDA_PLDA = [scores_LDA_PLDA.true;scores_LDA_PLDA.impostor];
[eer_baseline_BPCA400_LDA200_PLDA200,~,dcf_timit_baseline_BPCA400_LDA200_PLDA200]=compute_eer(scores_LDA_PLDA,answer_eva,false);
...
fprintf('|BPCA(%d)+LDA+PLDA(%d)|    %2.2f    |   %2.4f    |\n', num.IVdim,ldaDim,eer_baseline_BPCA400_LDA200_PLDA200,dcf_timit_baseline_BPCA400_LDA200_PLDA200);
fprintf('+---------------+-------------+-------------+\n');
