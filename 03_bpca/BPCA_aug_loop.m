...
%% ------------------------------------------------TIMIT database 
% GMM supervectors
M_dev_all = importdata('E:/data_prep/timit_aug_1_8/M_dev.mat');
M_enroll = importdata('E:/data_prep/timit_aug_1_8/M_enroll.mat');
M_test   = importdata('E:/data_prep/timit_aug_1_8/M_test.mat');
...
num.enroll = 9;
num.test = 1;
num.label_dev = repmat([1:1:66],50,1); % for PLDA
