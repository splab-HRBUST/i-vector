%% ------------------------------------------------TIMIT database 
% GMM supervectors
M_dev_all = importdata('E:/DataPrep/timit150/M_dev.mat');
M_enroll = importdata('E:/DataPrep/timit150/M_enroll.mat');
M_test   = importdata('E:/DataPrep/timit150/M_test.mat');
...
num.enroll = 9;
num.test = 1;
num.label_dev = repmat([1:1:150],10,1); % for PLDA
...
for iTers = 1 : 25
    ...
    [eer_baseline_BPCA400_LDA150_CDS(iTers),~,dcf_timit_baseline_BPCA400_LDA150_CDS(iTers)]=compute_eer(scores_LDA_CDS,answer_eva,false);
    ...
    [eer_BPCA400_PLDA150(iTers),~,dcf_timit_BPCA400_PLDA150(iTers)]=compute_eer(scores_BPCA_PLDA,answer_eva,false);
    ...
    [eer_baseline_BPCA400_LDA150_PLDA150(iTers),~,dcf_timit_baseline_BPCA400_LDA150_PLDA150(iTers)]=compute_eer(scores_LDA_PLDA,answer_eva,false);
    ...
    fprintf('|BPCA(%d)+LDA+CDS    |    %2.2f    |   %2.4f    |\n',num.IVdim, eer_baseline_BPCA400_LDA150_CDS(iTers),dcf_timit_baseline_BPCA400_LDA150_CDS(iTers));
    fprintf('|BPCA(%d)+PLDA(%d)|    %2.2f    |   %2.4f    |\n', num.IVdim,num.Zdim,eer_BPCA400_PLDA150(iTers),dcf_timit_BPCA400_PLDA150(iTers));
    fprintf('|BPCA(%d)+LDA+PLDA(%d)|    %2.2f    |   %2.4f    |\n', num.IVdim,ldaDim,eer_baseline_BPCA400_LDA150_PLDA150(iTers),dcf_timit_baseline_BPCA400_LDA150_PLDA150(iTers));
    fprintf('+---------------+-------------+-------------+\n');
