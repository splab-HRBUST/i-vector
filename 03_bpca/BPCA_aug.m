...
%% ------------------------------------------------TIMIT database 
% GMM supervectors
M_dev_all = importdata('E:/data_prep/timit_aug_1_2/M_dev.mat');
M_enroll = importdata('E:/data_prep/timit_aug_1_2/M_enroll.mat');
M_test   = importdata('E:/data_prep/timit_aug_1_2/M_test.mat');
...
num.enroll = 9;
num.test = 1;
num.label_dev = repmat([1:1:265],50,1); % for PLDA
...
for nSpk = 1 : num.spk_dev
    M_dev(:,(nSpk-1)*num.ch+1:nSpk*num.ch) =  M_dev_all(:,(nSpk-1)*50+1:(nSpk-1)*50+num.ch);
end
clear nSpk
...
scores_LDA_PLDA_impostor = [scores_LDA_PLDA.impostor];
