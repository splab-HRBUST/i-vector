%% ------------------------------------------------TIMIT database 
% GMM supervectors
M_dev_all = importdata('E:/DataPrep/timit200/M_dev.mat');
M_enroll = importdata('E:/DataPrep/timit200/M_enroll.mat');
M_test   = importdata('E:/DataPrep/timit200/M_test.mat');
...
num.enroll = 9;
num.test = 1;
num.label_dev = repmat([1:1:200],10,1); % for PLDA
