function gmm = gmm_em(dataList, nmix, final_niter, ds_factor, nworkers, ubm0, gmmFilename)
...
if nargin > 5
    ...
    fprintf('\n\nInitial UBM is provided by the last estimation...\n');
    gmm = ubm0;
    ...
    niter = [1 2 4 4  4  4  6  6   10  10  0    0];%  15];
