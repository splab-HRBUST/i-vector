function gmm = mapAdapt(dataList, ubmFilename, tau, config, gmmFilename)  % 得到音频文件的gmm参数 -- Mi = gmm.mu
...
%
% Outputs:
%   - gmm		  : a structure containing the GMM hyperparameters  包含GMM超参数的结构
